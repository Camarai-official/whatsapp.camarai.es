...
const cards = [
  {
    ...
    desc: "Elimina la fricción y los métodos obsoletos como CAPTCHA o 2FA. Aumenta la conversión al ofrecer un acceso inmediato y transparente para el usuario.",
    img: img1,
