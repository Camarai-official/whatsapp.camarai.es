  ...
  return (
    <PageWrapper id="page03">
      ...
      >
        ...
        <p>
          Cada fricción en el acceso es una barrera invisible que aleja a tus usuarios. <span className="text-green-400">Camarai Login</span> elimina esa fricción con un flujo tan natural como <span className="text-slate-200 font-semibold">enviar un mensaje de WhatsApp.</span>
        </p>
      </motion.div>
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-8 w-full max-w-6xl mx-auto">
        {steps.map(({ title, action, ocurre, valor, img, bgColor }, i) => (
          <motion.div
            ...
            className="relative flex flex-col gap-4 p-4 rounded-2xl bg-gray-950/20 hover:bg-gray-950/40 border border-slate-300/20 hover:scale-103 transition-transform flex-1 text-left"
          >
            {/* Luz difusa detrás del icono */}
